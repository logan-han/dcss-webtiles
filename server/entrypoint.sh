...
rm -f /data/running/*.ttyrec /data/sockets/*.sock /data/sockets/*.socket
...
# LOBBY_URL (e.g. https://crawl.example.com/) completes the links printed by `webserver/wtutil.py password --reset`
